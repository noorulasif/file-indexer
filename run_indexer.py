...
Starts the indexer, watches for file changes, and indexes content.
"""
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Start indexer with default config.json
  ...
  # Show status of running indexer (if PID file exists)
...
def main():
    ...
    # Print banner
    print("=" * 60)
    print("FILE INDEXER - Background Indexing Service")
    print("=" * 60)
    print()
